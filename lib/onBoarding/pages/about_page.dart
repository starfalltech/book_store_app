import 'package:book_store_app/authentication/presentation/pages/parent_registration_page.dart';
                ...
                ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const ParentRegistrationPage(),
                        ),
                      );
                    },
                    style: ElevatedButton.styleFrom(
                        ...
                        side: const BorderSide(
                            width: 1, color: Color(0xff944832))),
                    child: Text(
                      'Get Started',
                      style: GoogleFonts.urbanist(
                          fontWeight: FontWeight.w700,
